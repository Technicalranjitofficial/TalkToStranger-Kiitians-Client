  ...
  return (
    <motion.div initial={{opacity:0,scale:0.8}} animate={{opacity:1,scale:1}} transition={{opacity:{duration:0.2}}} style={{
      originX:message.isSender?1:0,
       ...
       <div className={`w-auto min-w-[55px] flex ${message.isSender?" items-end":""} flex-col py-3 pl-2 pr-5 ${message.isSender?"rounded-tl-3xl ":"rounded-tr-3xl"}  border border-gray-800 flex flex-col ${message.isSender?"bg-blue-800":"bg-gray-800"}`}>
